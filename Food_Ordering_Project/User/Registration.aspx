            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                            <asp:Label ID="NameLabel" runat="server" Text="Name" style="color:black;font-size:25px;"></asp:Label>
                        ...
                        <div>
                            <asp:Label ID="UsernameLabel" runat="server" Text="Username" style="color:black;font-size:25px;"></asp:Label>
                        ...
                        <div><asp:Label ID="EmailLabel" runat="server" Text="Email" style="color:black;font-size:25px;"></asp:Label>
                        ...
                        <div>
                            <asp:Label ID="PhoneNumberLabel" runat="server" Text="Phone Number" style="color:black;font-size:25px;"></asp:Label>
                ...
                <div class="col-md-6">
                    <div class="form_container">
                        <div>
                            <asp:Label ID="AddressLabel" runat="server" Text="Address" style="color:black;font-size:25px;"></asp:Label>
                        ...
                        <div>
                            <asp:Label ID="PostCodeLabel" runat="server" Text="Post Code" style="color:black;font-size:25px;"></asp:Label>
                        ...
                        <div>
                            <asp:Label ID="UserImageLabel" runat="server" Text="User Image" style="color:black;font-size:25px;"></asp:Label>
                            <asp:FileUpload ID="fuUserImage" runat="server" CssClass="form-control" ToolTip="User Image"
                                onchange="ImagePreview(this);" />
                        </div>
                        <div>
                            <asp:Label ID="PasswordLabel" runat="server" Text="Password" style="color:black;font-size:25px;"></asp:Label>
